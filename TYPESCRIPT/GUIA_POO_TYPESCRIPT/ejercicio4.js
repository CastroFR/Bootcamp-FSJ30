...
var Cuenta = /** @class */ (function () {
    ...
    Cuenta.prototype.depositar = function () {
        ...
        if (this.cantidad < 5) {
            ...
            console.log("\nSe ha depositado correctamente la cantidad de: $".concat(this.cantidad.toFixed(2)));
        }
    };
    // metodo retirar
    Cuenta.prototype.retirar = function (valor) {
        if (valor < 5) {
            ...
            this.cantidad -= valor;
            console.log("Ha retirado: $".concat(valor.toFixed(2), ". Saldo restante: $").concat(this.cantidad.toFixed(2)));
        }
    };
...
var demoCuenta = new Cuenta("Anacleto Escoba", 4, "Ahorro", "1234567890");
